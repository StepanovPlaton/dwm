...
static const char dmenufont[]       = "CodeNewRoman Nerd Font Mono:size=12:antialias=true:autohint=true";
...
static const char *dmenucmd[] = { "dmenu_run", "-x", "8", "-y", "10", "-z", "1280", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray, "-nf", col_white, "-sb", col_gray, "-sf", col_yellow, NULL };
